...
class TestFileSave(TestCase):
    ...
    def test_save_file_inspector(self):
        source_instance = SourceListModel.objects.create(
            ...
            field_labels='lic_type::lic_number::fullname::suffix::lic_status::lic_date_orig::lic_date_exp::trec_ed_status::trec_mce_status::designated_supervisor::phone::email::address_2::address_3::address_4::city::state::zip::county'
        )
        save_source('intx')
    ...
    def test_save_file_appraiser_tx(self):
        source_instance = SourceListModel.objects.create(
            ...
            field_labels='lic_type::lic_number::fullname::suffix::lic_status::lic_date_orig::lic_date_exp::email::phone::address_2::address_3::address_4::city::state::zip::county'
        )
        save_source('aptx')
    ...
    def test_save_file_trec(self):
        source_instance = SourceListModel.objects.create(
            ...
            field_labels='lic_type::lic_number::fullname::suffix::lic_status::lic_date_orig::lic_date_exp::trec_ed_status::trec_mce_status::designated_supervisor::email::phone::address_2::address_3::address_4::city::state::zip::county'
        )
        save_source('trec')
    ...
    def test_save_file_txprep(self):
        source_instance = SourceListModel.objects.create(
            ...
            field_labels='lic_type::app_date_orig::app_date_exp::lastname::firstname::middlename::suffix::address_2::address_3::address_4::city::state::zip::phone::email'
        )
